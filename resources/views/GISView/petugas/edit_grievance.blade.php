                            ...
                            <div class="px-4 flex flex-col gap-2">
                                <div class="flex gap-2 flex-col sm:flex-row w-full">
                                    <div class="flex flex-col w-full">
                                        <input type="hidden" name="id" value="{{$grievance->grievance_id}}">
                                        <label for="dateInput" class="block text-sm font-medium text-slate-600">Hari/Tanggal</label>
                                        <div class="mt-1 relative">
                                            <input type="date" id="dateInput" name="tanggal" value="{{$grievance->tanggal}}" class="form-input px-2 py-1 block w-full leading-5 rounded-md border  focus:outline-none focus:ring-1 focus:ring-blue-400">
                                        </div>
                                    </div>
                                </div>
                                <div class="flex gap-2 flex-col sm:flex-row w-full">
                                    <div class="flex flex-col w-full">
                                        ...
                                        <div class="mt-1 relative">
                                            <input type="text" id="dateInput" name="locations" value="{{$grievance->locations}}" class="form-input px-2 py-1 block w-full leading-5 rounded-md border  focus:outline-none focus:ring-1 focus:ring-blue-400">
                                        </div>
                                    </div>
                                </div>
                                <div class="flex gap-2">
                                    <div class="flex flex-col w-full">
                                        ...
                                        <input type="text" name="complainants" id="namaPelapor" value="{{$grievance->complainants}}" class="px-2 py-1 border  focus:outline-none focus:ring-1 focus:ring-blue-400 rounded-md w-full uppercase">
                                    </div>
                                    <div class="flex flex-col w-full">
                                        <label for="inputRt" class="font-semibold text-slate-600 text-base">RT/RW</label>
                                        <input type="text" name="rt_rw" id="inputRt" value="{{$grievance->rt_rw}}" class="px-2 py-1 border  focus:outline-none focus:ring-1 focus:ring-blue-400 rounded-md w-full uppercase">
                                    </div>
                                </div>
                                <div class="flex gap-2">
                                    <div class="flex flex-col w-full">
                                        <label for="inputDusun" class="font-semibold text-slate-600 text-base">Dusun/Kampung</label>
                                        <input type="text" name="kampung" id="inputDusun" value="{{$grievance->kampung}}" class="px-2 py-1 border focus:outline-none focus:ring-1 focus:ring-blue-400 rounded-md w-full uppercase">
                                    </div>
                                    <div class="flex flex-col w-full">
                                        <label for="desa" class="font-semibold text-slate-600 text-base">Desa</label>
                                        <input type="text" name="desa" id="desa" value="{{$grievance->desa}}" class="px-2 py-1 border  focus:outline-none focus:ring-1 focus:ring-blue-400 rounded-md w-full uppercase">
                                    </div>
                                </div>
                                <div class="flex flex-col">
                                    <label for="noKTP" class="font-semibold text-slate-600 text-base">No. KTP</label>
                                    <input type="number" name="no_ktp" id="noKTP" value="{{$grievance->no_ktp}}" class="px-2 py-1 border  focus:outline-none focus:ring-1 focus:ring-blue-400 rounded-md w-full uppercase">
                                </div>
                                <div class="flex flex-col">
                                    <label for="noKontak" class="font-semibold text-slate-600 text-base">No. Kontak Pelapor</label>
                                    <input type="number" name="no_telp" id="noKontak" value="{{$grievance->no_telp}}" class="px-2 py-1 border  focus:outline-none focus:ring-1 focus:ring-blue-400 rounded-md w-full uppercase">
                                </div>
                                <div class="flex flex-col">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <textarea name="issue" id="" class="px-2 py-1 border  focus:outline-none focus:ring-1 focus:ring-blue-400 rounded-md w-full">{{$grievance->issue}}</textarea>
                                </div>
                                <div class="flex flex-col">
                                    <label class="font-semibold text-slate-600 text-base">Jalur aduan </label>
                                    <input name="jalur_aduan" type="text" value="{{$grievance->jalur_aduan}}" class="px-2 py-1 border  focus:outline-none focus:ring-1 focus:ring-blue-400 rounded-md w-full">
                                </div>
                                <div class="flex gap-2">
                                    <div class="flex flex-col w-full">
                                        <label class="font-semibold text-slate-600 text-base">Lattitude</label>
                                        <input type="text" name="lattitude" id="lat" value="{{$grievance->lattitude}}" class="px-2 py-1 border  focus:outline-none focus:ring-1 focus:ring-blue-400 rounded-md w-full uppercase">
                                    </div>
                                    <div class="flex flex-col w-full">
                                        <label class="font-semibold text-slate-600 text-base">Longitude</label>
                                        <input type="text" name="longitude" id="long" value="{{$grievance->longitude}}" class="px-2 py-1 border  focus:outline-none focus:ring-1 focus:ring-blue-400 rounded-md w-full">
                                    </div>
                                </div>
                                <div class="flex flex-col">
